...
import { NuevaNotaCreditoTab } from "@/components/notas/nueva-nota-credito-tab"
import { HistorialNotasTab } from "@/components/notas/historial-notas-tab"
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
        <div className="mb-6">
          <h2 className="text-2xl font-bold sm:text-3xl">Gestión de Notas de Crédito</h2>
          <p className="mt-1 text-sm text-muted-foreground sm:text-base">
            Emite notas de crédito para anular o modificar comprobantes
          </p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="historial">
            <HistorialNotasTab tipo="credito" />
          </TabsContent>
        </Tabs>
      </main>
    </div>
